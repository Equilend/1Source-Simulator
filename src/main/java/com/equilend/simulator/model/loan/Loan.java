...
package com.equilend.simulator.model.loan;
...
public class Loan {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(loanId, lastEvent, loanStatus, lastUpdatePartyId, lastUpdateDateTime, isInitiator, trade, settlement, parentLoanId);
  }
