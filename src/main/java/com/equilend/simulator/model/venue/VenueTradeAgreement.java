...
public class VenueTradeAgreement {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(executionVenue, instrument, rate, quantity, billingCurrency, dividendRatePct, tradeDate,
            termType, termDate, settlementDate, settlementType, collateral, transactingParties);
    }
