...
/**
 * A third-party service that generates contracts, returns, recalls, rerates
 */
@Schema(description = "A third-party service that generates contracts, returns, recalls, rerates")
