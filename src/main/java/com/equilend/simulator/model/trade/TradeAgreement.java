...
public class TradeAgreement {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(venues, instrument, rate, quantity, openQuantity, billingCurrency, dividendRatePct,
            tradeDate, termType, termDate, settlementDate, settlementType, collateral, transactingParties);
    }
