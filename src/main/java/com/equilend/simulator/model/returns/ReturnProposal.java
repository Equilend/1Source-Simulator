...
public class ReturnProposal {
  ...
  **/
  ...
  public ReturnProposal collateralValue(Double collateralValue) {
   ...
   /**
   * The collateral value of the shares being returned, in the collateral currency on the loan contract.
   * @return collateralValue
  **/
  @Schema(required = true, description = "The collateral value of the shares being returned, in the collateral currency on the loan contract.")
