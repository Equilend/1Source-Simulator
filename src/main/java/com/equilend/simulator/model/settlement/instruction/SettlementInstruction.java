...
public class SettlementInstruction {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(settlementBic, localAgentBic, localAgentName, localAgentAcct, dtcParticipantNumber,
            cdsCustomerUnitId, custodianName, custodianBic, custodianAcct);
    }
